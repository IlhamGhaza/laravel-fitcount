<div style="width: 100%; background: white; height: 79px;">
    <header class="Navbar" style="width: 100%; max-width: 1440px; height: 79px; position: relative; background: white; margin: 0 auto;">
        ...
        <div class="menu-container"
            style="display: flex; position: absolute; right: 200px; top: 22px; gap: 30px;">
            <a href="{{ route('home') }}" style="text-decoration: none;">
                <div class="Utama"
